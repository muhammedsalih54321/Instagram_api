...
class Followingmodel {
    ...
    Followingmodel({this.data, this.paginationToken});
    ...
    static List<Followingmodel> fromList(List<Map<String, dynamic>> list) {
        return list.map((map) => Followingmodel.fromJson(map)).toList();
    }
