...
class Items {
    ...
    int? hasSharedToFb;
    String? id;
    IgIabPostClickData? igIabPostClickData;
    ...
    Items.fromJson(Map<String, dynamic> json) {
        ...
        if(json["ig_iab_post_click_data"] is Map) {
            igIabPostClickData = json["ig_iab_post_click_data"] == null ? null : IgIabPostClickData.fromJson(json["ig_iab_post_click_data"]);
        }
    ...
    Map<String, dynamic> toJson() {
        ...
        _data["id"] = id;
        if(igIabPostClickData != null) {
            _data["ig_iab_post_click_data"] = igIabPostClickData?.toJson();
        }
    ...
    Items copyWith({
        ...
        id: id ?? this.id,
        igIabPostClickData: igIabPostClickData ?? this.igIabPostClickData,
...
class IgIabPostClickData {
    BuyWithPrimeIabPostClickDataExtension? buyWithPrimeIabPostClickDataExtension;

    IgIabPostClickData({this.buyWithPrimeIabPostClickDataExtension});

    IgIabPostClickData.fromJson(Map<String, dynamic> json) {
        if(json["buyWithPrimeIABPostClickDataExtension"] is Map) {
            buyWithPrimeIabPostClickDataExtension = json["buyWithPrimeIABPostClickDataExtension"] == null ? null : BuyWithPrimeIabPostClickDataExtension.fromJson(json["buyWithPrimeIABPostClickDataExtension"]);
        }
    }

    static List<IgIabPostClickData> fromList(List<Map<String, dynamic>> list) {
        return list.map((map) => IgIabPostClickData.fromJson(map)).toList();
    }

    Map<String, dynamic> toJson() {
        final Map<String, dynamic> _data = <String, dynamic>{};
        if(buyWithPrimeIabPostClickDataExtension != null) {
            _data["buyWithPrimeIABPostClickDataExtension"] = buyWithPrimeIabPostClickDataExtension?.toJson();
        }
        return _data;
    }

    IgIabPostClickData copyWith({
        BuyWithPrimeIabPostClickDataExtension? buyWithPrimeIabPostClickDataExtension,
    }) => IgIabPostClickData(
        buyWithPrimeIabPostClickDataExtension: buyWithPrimeIabPostClickDataExtension ?? this.buyWithPrimeIabPostClickDataExtension,
    );
}

class BuyWithPrimeIabPostClickDataExtension {
    String? accessToken;
    dynamic accessTokenCreationTime;
    int? accessTokenTtl;
    String? apiKey;
    String? bauProductUrl;
    String? buyWithPrimeExperienceType;
    String? clientId;
    String? pageName;

    BuyWithPrimeIabPostClickDataExtension({this.accessToken, this.accessTokenCreationTime, this.accessTokenTtl, this.apiKey, this.bauProductUrl, this.buyWithPrimeExperienceType, this.clientId, this.pageName});

    BuyWithPrimeIabPostClickDataExtension.fromJson(Map<String, dynamic> json) {
        if(json["accessToken"] is String) {
            accessToken = json["accessToken"];
        }
        accessTokenCreationTime = json["accessTokenCreationTime"];
        if(json["accessTokenTTL"] is num) {
            accessTokenTtl = (json["accessTokenTTL"] as num).toInt();
        }
        if(json["apiKey"] is String) {
            apiKey = json["apiKey"];
        }
        if(json["bauProductUrl"] is String) {
            bauProductUrl = json["bauProductUrl"];
        }
        if(json["buyWithPrimeExperienceType"] is String) {
            buyWithPrimeExperienceType = json["buyWithPrimeExperienceType"];
        }
        if(json["clientID"] is String) {
            clientId = json["clientID"];
        }
        if(json["pageName"] is String) {
            pageName = json["pageName"];
        }
    }

    static List<BuyWithPrimeIabPostClickDataExtension> fromList(List<Map<String, dynamic>> list) {
        return list.map((map) => BuyWithPrimeIabPostClickDataExtension.fromJson(map)).toList();
    }

    Map<String, dynamic> toJson() {
        final Map<String, dynamic> _data = <String, dynamic>{};
        _data["accessToken"] = accessToken;
        _data["accessTokenCreationTime"] = accessTokenCreationTime;
        _data["accessTokenTTL"] = accessTokenTtl;
        _data["apiKey"] = apiKey;
        _data["bauProductUrl"] = bauProductUrl;
        _data["buyWithPrimeExperienceType"] = buyWithPrimeExperienceType;
        _data["clientID"] = clientId;
        _data["pageName"] = pageName;
        return _data;
    }

    BuyWithPrimeIabPostClickDataExtension copyWith({
        String? accessToken,
        dynamic accessTokenCreationTime,
        int? accessTokenTtl,
        String? apiKey,
        ...
        String? clientId,
        String? pageName,
    }) => BuyWithPrimeIabPostClickDataExtension(
        accessToken: accessToken ?? this.accessToken,
        accessTokenCreationTime: accessTokenCreationTime ?? this.accessTokenCreationTime,
        accessTokenTtl: accessTokenTtl ?? this.accessTokenTtl,
        apiKey: apiKey ?? this.apiKey,
        bauProductUrl: bauProductUrl ?? this.bauProductUrl,
        buyWithPrimeExperienceType: buyWithPrimeExperienceType ?? this.buyWithPrimeExperienceType,
